...
export class Default1685853004776 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ALTER TABLE \`preparo\`
            ADD CONSTRAINT \`FK_08445febe6c4d488c9bd0956dff\` FOREIGN KEY (\`receita_id\`) REFERENCES \`receita\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION
        `)
    await queryRunner.query(`
            ALTER TABLE \`ingrediente\`
            ADD CONSTRAINT \`FK_414b95eb5f6c026b503033990db\` FOREIGN KEY (\`receita_id\`) REFERENCES \`receita\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION
        `)
  }
